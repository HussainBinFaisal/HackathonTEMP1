...
const Topbar = () => {
    return (
        <div className='w-full px-40 h-11 flex items-center justify-between bg-purple'>
            <div className="flex justify-start items-center gap-5">
                <div className='flex justify-start gap-2 items-center'>
                    <MdOutlineMail className='text-white' />
                    <p className='text-white font-semibold font-josefin-sans'>idk@gmail.com</p>
                </div>
                <div className='flex justify-start gap-2 items-center'>
                    <FiPhoneCall className='text-white' />
                    <p className='text-white font-semibold font-josefin-sans'>911</p>
                </div>
            </div>
            <div className='flex justify-end gap-2'>
                ...
                <button className='bg-transparent text-white border-none outline-none font-semibold font-josefin-sans flex items-center gap-1'>Login <BiUser color={'white'} /></button>
                ...
                <button className='bg-transparent text-white border-none outline-none pl-3 text-lg'><FiShoppingCart color={'white'} /></button>
            </div>
        </div>
    )
}
